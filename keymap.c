...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ergodox(
        ...
        KC_LCTRL, KC_TRNS, KC_TRNS, KC_LALT, KC_RGUI,
        ...
        KC_RGUI, KC_RALT, KC_TRNS, TT(1), KC_PIPE,
    ...
    [NORMIE] = LAYOUT_ergodox(
        ...
        KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LPRN,
        KC_LCTRL, KC_COMMA, KC_DOT, KC_LALT, LT(2, KC_GRAVE),
        ...
        KC_RGUI, TO(0), KC_DOWN, KC_UP, KC_RIGHT,
        KC_PGDOWN, KC_PGUP, KC_HOME, KC_END, KC_DELETE, KC_ENTER),

    [CODE] = LAYOUT_ergodox(
        // Left hand
        M_SELECTCOPY, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_TRNS,
        LCTL(KC_C), KC_EXLM, KC_AT, KC_LCBR, KC_RCBR, KC_PIPE, LCTL(LSFT(KC_TAB)),
        LCTL(KC_V), KC_HASH, KC_DLR, KC_LPRN, KC_RPRN, KC_GRAVE,
        ...
        KC_TRNS, KC_4, KC_5, KC_6, KC_AMPR, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_1, KC_2, KC_3, KC_TRNS, KC_BSLASH,
